...
ssd1306::ssd1306(){
        ...
        this->defaultFont = Font_16x26;
    #endif
    #ifdef SSD1306_INCLUDE_FONT_11x18
        this->defaultFont = Font_11x18;
    #endif
    #ifdef SSD1306_INCLUDE_FONT_7x10
        this->defaultFont = Font_7x10;
    #endif
    #ifdef SSD1306_INCLUDE_FONT_6x8
        this->defaultFont = Font_6x8;
    #endif
...
void ssd1306::initi2cMode(I2C_HandleTypeDef* i2c, uint8_t i2cAddx){
    this->i2cPort = i2c;
    this->SPIMode = false;
    this->i2cAddx = i2cAddx;
}

void ssd1306::initSpiMode(SPI_HandleTypeDef* spi){
    this->spiPort = spi;
    this->SPIMode = true;
}
...
void ssd1306::WriteCommand(uint8_t byte) {
    HAL_I2C_Mem_Write(this->i2cPort, this->i2cAddx, 0x00, 1, &byte, 1, HAL_MAX_DELAY);
}

// Send data
void ssd1306::WriteData(uint8_t* buffer, size_t buff_size) {
    HAL_I2C_Mem_Write(&this->i2cPort, this->i2cAddx, 0x40, 1, buffer, buff_size, HAL_MAX_DELAY);
}
...
static float ssd1306::DegToRad(float par_deg) {
    return par_deg * 3.14 / 180.0;
}
/*Normalize degree to [0;360]*/
static uint16_t ssd1306::NormalizeTo0_360(uint16_t par_deg) {
  uint16_t loc_angle;
  if(par_deg <= 360)
  {
    loc_angle = par_deg;
